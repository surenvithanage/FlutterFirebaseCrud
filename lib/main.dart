...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Title',
      home: FirebaseStoreDemo(),
    );
  }
}

class FirebaseStoreDemo extends StatefulWidget {
  FirebaseStoreDemo() : super();

  final String title = "CloudFireStore";

  @override
  FirebaseStoreDemoState createState() => FirebaseStoreDemoState();
}

class FirebaseStoreDemoState extends State<FirebaseStoreDemo> {
  ...
  Widget buildList(BuildContext context, List<DocumentSnapshot> snapshot) {
    return ListView(
      children: snapshot.map((data) => buildListItem(context, data)
    ).toList());
  }
